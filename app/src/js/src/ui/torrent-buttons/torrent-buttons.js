      ...
      <div className='item-buttons'>
          <button className='button-options' onClick={() => this.props.onExpand}><i className='icon-cog'></i></button>
          {
            this.props.info.completed ?
              ...
              (this.props.download.url ? <button className='button-revert' onClick={() => TorrentActions.downloadWithHttp(this.props.download)}><i className='icon-arrows-cw'></i></button> : null)
          }
